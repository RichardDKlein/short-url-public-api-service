...
package com.richarddklein.shorturlpublicapiservice.exception;

import com.richarddklein.shorturlpublicapiservice.dto.ShortUrlPublicApiStatus;
import com.richarddklein.shorturlpublicapiservice.dto.Status;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Status> handleNoResourceFoundException(
        ...
        logger.warn("====> ", e);
        Status status = new Status(ShortUrlPublicApiStatus.UNKNOWN_ERROR, e.getMessage());
